...
export function renderTab(tab, { horizon = 7, snapshots = [], inspiration = [], dismissed = [] }) {
  ...
  const sectionDefs = [
    ...
    { key: "audience-snapshot", title: "Integrated Audience results — YouTube Studio videos", note: "Exact videos from this niche's Audience screenshots plus topical overlaps from related source channels. Duplicate videos are deduped and show every source screenshot they appeared in." },
