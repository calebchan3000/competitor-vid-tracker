...
function videoRow(v, slug, { showNiche = false, inspirationSet = new Set() } = {}) {
  ...
  return `<tr class="vrow vrow--${t.key} ${hot ? "vrow--hot" : ""}"
    ...
    <td class="c-title">${hot ? '<span class="flame">🔥</span> ' : ""}${title}${dismissButton(v, slug)}${showNiche && v.niche ? `<span class="muted niche-tag"> · ${escapeHtml(v.niche)}</span>` : ""}${labelBadges}${addedMeta(v)}</td>
