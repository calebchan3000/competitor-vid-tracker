...
function buildEdselGroupedSections(rows) {
  const sourceOrder = ["anti-dem", "anti-maga", "canada", "new-york", "british-news", "unknown"];
  ...
  return [...bySource.entries()]
    ...
    .flatMap(([sourceSlug, byStyle]) => [...byStyle.values()]
      ...
      .map((group) => ({
        ...
        note: `All Edsel picks tagged source-${sourceSlug} in this section. Sorted by outlier score; no 7-day or top-10 cap is applied.`,
