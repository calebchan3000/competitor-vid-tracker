...
function shouldAutoRouteToAntiMaga(slug, video) {
  // Edsel Picks is an aggregate/source tab: it intentionally contains rows from
  // multiple niches, including anti-MAGA-labeled picks, so do not route them away.
  return slug !== "anti-maga" && slug !== "edsel-picks" && labelsIncludeAntiMaga(video.labels);
}
