...
export function normalizeTopicLabel(label) {
  ...
  if (key === "anti-trump" || key === "anti-maga") return "anti-maga";
  return text;
}

export function labelsIncludeAntiMaga(labels) {
  return splitLabels(labels).some((label) => label.toLowerCase() === "anti-maga");
}
